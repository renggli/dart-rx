...
Map1<Observable<Observable<R>>, Observable<R>> exhaustAll<R>(
        {int concurrent = 1}) =>
...
/// this threshold.
Map1<Observable<T>, Observable<R>> exhaustMap<T, R>(
...
/// Subscribes to at most `concurrent` sources, drops observables exceeding
/// this threshold.
Map1<Observable, Observable<R>> exhaustMapTo<R>(Observable<R> observable,
        {int concurrent = 1}) =>
